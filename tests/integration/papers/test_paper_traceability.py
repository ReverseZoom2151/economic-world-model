"""Integration contracts for paper-to-code traceability."""
...
def test_forecasting_population_targets_are_separate_from_authored_damping() -> None:
    ...
    assert "tests/integration/papers/test_independent_numerical_oracles.py" in population[
        "evidence"
    ]
...
def test_restricted_theorem_certificates_do_not_overclaim_general_kakutani() -> None:
    ...
    assert "tests/unit/equilibrium/test_theorem_certificates.py" in proposition["evidence"]
...
def test_independent_production_oracle_preserves_the_paper_authored_boundary() -> None:
    ...
    assert "tests/integration/papers/test_independent_numerical_oracles.py" in production[
        "evidence"
    ]
...
def test_locked_credit_failure_and_synthetic_han_validation_are_explicit() -> None:
    ...
    assert "tests/integration/experiments/test_locked_protocol_smoke.py" in credit["evidence"]
