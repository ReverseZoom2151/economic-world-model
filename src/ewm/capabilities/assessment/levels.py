...
def documented_prototype_evidence() -> tuple[CapabilityEvidence, ...]:
    ...
    return (
        ...
        CapabilityEvidence(
            ...
            True,
            EvidenceKind.SYNTHETIC_TEST,
            "tests/unit/capabilities/test_cognition.py:fake-backend",
        ),
        CapabilityEvidence(
            LevelRequirement.EXPLICIT_COGNITIVE_STATE,
            True,
            EvidenceKind.SYNTHETIC_TEST,
            "tests/unit/capabilities/test_cognition.py",
        ),
        CapabilityEvidence(
            LevelRequirement.MEMORY_AND_TOOLS,
            True,
        ...
        CapabilityEvidence(
            ...
            True,
            EvidenceKind.SYNTHETIC_TEST,
            "tests/unit/capabilities/test_capability_evolution.py",
        ),
        CapabilityEvidence(
            LevelRequirement.CAPABILITY_ROLLBACK,
            True,
        ...
        CapabilityEvidence(
            ...
            True,
            EvidenceKind.SYNTHETIC_TEST,
            "tests/unit/capabilities/test_institutions.py",
        ),
        CapabilityEvidence(
            LevelRequirement.ACCEPTED_INSTITUTION_CHANGE,
            True,
        ...
        CapabilityEvidence(
            ...
            True,
            EvidenceKind.SYNTHETIC_TEST,
            "tests/unit/capabilities/test_alignment.py:single-fixture",
        ),
    )
